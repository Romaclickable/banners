...
(lib.Символ9 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("ДЛЯ ПОБЕДИТЕЛЕЙ", "bold 28px 'Intro Black Italic'", "#FFFFFF");
...
}).prototype = getMCSymbolPrototype(lib.Символ9, new cjs.Rectangle(-28,0,301.9,83), null);
...
(lib.Символ8 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("СПОРТИВНЫЕ СТАВКИ", "bold 28px 'Intro Black Italic'", "#FFFFFF");
	this.text.lineHeight = 30;
...
}).prototype = getMCSymbolPrototype(lib.Символ8, new cjs.Rectangle(-31.3,0,364.3,110), null);
...
(lib.betcity = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(449.5,257,1,1,0,0,0,156.5,43);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1502703329816", id:"bg"},
		{src:"images/bliki.jpg?1502703329816", id:"bliki"},
		{src:"images/btn1.png?1502703329816", id:"btn1"},
		{src:"images/btn2.png?1502703329816", id:"btn2"},
		{src:"images/kubok.png?1502703329816", id:"kubok"},
		{src:"images/kubok_r.png?1502703329816", id:"kubok_r"},
		{src:"images/logo_betsiti.png?1502703329816", id:"logo_betsiti"},
		{src:"images/money.png?1502703329816", id:"money"},
		{src:"images/Shape1.png?1502703329816", id:"Shape1"},
		{src:"images/Shape2.png?1502703329816", id:"Shape2"},
		{src:"images/Shape3.png?1502703329816", id:"Shape3"}
	],
	preloads: []
};
