...
p.nominalBounds = new cjs.Rectangle(0,0,82,54);
...
(lib.Символ25 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,0,1.067,1.067);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ25, new cjs.Rectangle(0,0,87.5,57.6), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ24, new cjs.Rectangle(0,0,76,63), null);
...
(lib.Символ9 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(561.7,58.8,1,1,0,0,0,43.7,28.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.11,scaleY:1.11,y:58.9},9,cjs.Ease.get(-1)).to({scaleX:1.23,scaleY:1.23,x:561.8,y:58.8},10,cjs.Ease.get(1)).to({regX:43.8,scaleX:1.12,scaleY:1.12,x:561.9,y:58.9},10,cjs.Ease.get(-1)).to({regX:43.7,scaleX:1,scaleY:1,x:561.7,y:58.8},10,cjs.Ease.get(1)).wait(1));

	// Слой 3
	this.instance_1 = new lib.Символ24();
	this.instance_1.parent = this;
	this.instance_1.setTransform(72.2,61.7,1.345,1.345,0,0,0,38.1,31.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:1.18,scaleY:1.18,x:72.1,y:61.6},9,cjs.Ease.get(-1)).to({regX:38,regY:31.5,scaleX:1,scaleY:1,x:72,y:61.5},10,cjs.Ease.get(1)).to({scaleX:1.17,scaleY:1.17,x:72.1,y:61.6},10,cjs.Ease.get(-1)).to({regX:38.1,regY:31.6,scaleX:1.35,scaleY:1.35,x:72.2,y:61.7},10,cjs.Ease.get(1)).wait(1));

	// Слой 2
	this.instance_2 = new lib.flag();
	this.instance_2.parent = this;
	this.instance_2.setTransform(489,0);
...
p.nominalBounds = new cjs.Rectangle(0,0,658,305);
...
(lib.columbus = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(324,264.5,1,1,0,0,0,144,33.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(543,248,1,1,0,0,0,164,186);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(94,208,1,1,0,0,0,94,102);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(87.3,150.5,1,1,0,0,0,84.5,152.5);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(320.9,166,1,1,0,0,0,175.5,139);
...
p.nominalBounds = new cjs.Rectangle(320,-1749.2,707,2335.8);
// library properties:
lib.properties = {
	width: 640,
	height: 305,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1503414240502", id:"bg"},
		{src:"images/BTN.png?1503414240502", id:"BTN"},
		{src:"images/BTN2.png?1503414240502", id:"BTN2"},
		{src:"images/dama.png?1503414240502", id:"dama"},
		{src:"images/flag.png?1503414240502", id:"flag"},
		{src:"images/flash.png?1503414240502", id:"flash"},
		{src:"images/karta.png?1503414240502", id:"karta"},
		{src:"images/king.png?1503414240502", id:"king"},
		{src:"images/logo.png?1503414240502", id:"logo"},
		{src:"images/s1.jpg?1503414240502", id:"s1"},
		{src:"images/s2.jpg?1503414240502", id:"s2"},
		{src:"images/s3.png?1503414240502", id:"s3"},
		{src:"images/s4.jpg?1503414240502", id:"s4"},
		{src:"images/s5.png?1503414240502", id:"s5"},
		{src:"images/sunduk.png?1503414240502", id:"sunduk"},
		{src:"images/text1.png?1503414240502", id:"text1"},
		{src:"images/text2.png?1503414240502", id:"text2"},
		{src:"images/tip.png?1503414240502", id:"tip"},
		{src:"images/tuz.png?1503414240502", id:"tuz"},
		{src:"images/valet.png?1503414240502", id:"valet"}
	],
	preloads: []
};
