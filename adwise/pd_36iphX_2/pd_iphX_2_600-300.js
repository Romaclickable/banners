...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(7).to({_off:false},0).to({rotation:0,x:236,y:151},24).to({y:164.8},30).to({y:151},30).to({y:164.8},30).to({y:137.2},30).to({rotation:35.2,x:532.1,y:471.2},20).to({_off:true},1).wait(178));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(14).to({_off:false},0).to({rotation:0,x:197,y:205},24).to({y:218.8},30).to({y:205},30).to({y:218.8},30).to({y:191.2},30).to({rotation:35.2,x:522.1,y:469.4},20).to({_off:true},1).wait(171));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(22).to({_off:false},0).to({regX:133.5,rotation:0,x:197.5,y:242},24).to({y:255.8},30).to({y:242},30).to({y:255.8},30).to({y:228.2},30).to({regX:133.6,rotation:35.2,x:556.4,y:477.9},20).to({_off:true},1).wait(163));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(31).to({_off:false},0).to({x:225.5,y:317},24).to({y:330.8},30).to({y:317},30).to({y:330.8},30).to({y:303.2},30).to({regX:166.6,rotation:35.2,x:536.7,y:479.6},20).to({_off:true},1).wait(154));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Bitmap1.png?1509631367039", id:"Bitmap1"},
		{src:"images/buty.png?1509631367039", id:"buty"},
		{src:"images/con1.png?1509631367039", id:"con1"},
		{src:"images/con2.png?1509631367039", id:"con2"},
		{src:"images/con3.png?1509631367039", id:"con3"},
		{src:"images/fullho.png?1509631367039", id:"fullho"},
		{src:"images/gather.png?1509631367039", id:"gather"},
		{src:"images/kare.png?1509631367039", id:"kare"},
		{src:"images/orrr.png?1509631367039", id:"orrr"},
		{src:"images/PD_logo.png?1509631367039", id:"PD_logo"},
		{src:"images/phon2.png?1509631367039", id:"phon2"},
		{src:"images/phone1.png?1509631367039", id:"phone1"},
		{src:"images/phone3.png?1509631367039", id:"phone3"},
		{src:"images/que1.png?1509631367039", id:"que1"},
		{src:"images/que2.png?1509631367039", id:"que2"},
		{src:"images/ten1.png?1509631367039", id:"ten1"},
		{src:"images/ten2.png?1509631367039", id:"ten2"},
		{src:"images/ten3.png?1509631367039", id:"ten3"},
		{src:"images/ten4.png?1509631367039", id:"ten4"},
		{src:"images/theone.png?1509631367039", id:"theone"},
		{src:"images/thetwo.png?1509631367039", id:"thetwo"},
		{src:"images/Растровоеизображение1.png?1509631367039", id:"Растровоеизображение1"}
	],
	preloads: []
};
