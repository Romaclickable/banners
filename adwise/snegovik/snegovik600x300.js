...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bashka.png?1484735232303", id:"bashka"},
		{src:"images/bedro.png?1484735232303", id:"bedro"},
		{src:"images/bedro2.png?1484735232303", id:"bedro2"},
		{src:"images/bg2.jpg?1484735232303", id:"bg2"},
		{src:"images/FIRE.png?1484735232303", id:"FIRE"},
		{src:"images/golova1.png?1484735232303", id:"golova1"},
		{src:"images/mouse.png?1484735232303", id:"mouse"},
		{src:"images/noga.png?1484735232303", id:"noga"},
		{src:"images/noga2.png?1484735232303", id:"noga2"},
		{src:"images/nogi.png?1484735232303", id:"nogi"},
		{src:"images/ognemet.png?1484735232303", id:"ognemet"},
		{src:"images/plechopngкопия.png?1484735232303", id:"plechopngкопия"},
		{src:"images/plecho2.png?1484735232303", id:"plecho2"},
		{src:"images/plecho_t.png?1484735232303", id:"plecho_t"},
		{src:"images/rou.png?1484735232303", id:"rou"},
		{src:"images/rukapngкопия.png?1484735232303", id:"rukapngкопия"},
		{src:"images/ruka2.png?1484735232303", id:"ruka2"},
		{src:"images/ruka_t.png?1484735232303", id:"ruka_t"},
		{src:"images/shlyapa.png?1484735232303", id:"shlyapa"},
		{src:"images/telopngкопия.png?1484735232303", id:"telopngкопия"},
		{src:"images/telo_t.png?1484735232303", id:"telo_t"},
		{src:"images/zuby.png?1484735232303", id:"zuby"}
	]
};
...
(lib.Символ10 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({regX:190.8,skewX:-5.2,skewY:-5,x:15.2},14,cjs.Ease.get(-1)).to({regX:190.9,regY:99.7,skewX:0,skewY:1.2,y:103.7},15,cjs.Ease.get(1)).to({regX:190.8,regY:99.6,skewX:-5.2,skewY:-5,y:103.6},15,cjs.Ease.get(-1)).to({regX:190.9,skewX:0,skewY:0,x:17.8},15,cjs.Ease.get(1)).wait(1));
...
(lib.Символ55 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:59.2},9).to({x:133.6},10).wait(1));
...
(lib.snegovik600x300 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.text.setTransform(431.6,61.4,1,1,0,0,0,110.6,42.1);
	...
	this.strelka.setTransform(463.9,171.7,1,1,0,0,0,56.9,29);
	...
	this.snowman.setTransform(243.6,240,1,1,0,0,0,72,65);
	...
	this.instance.parent = this;
	this.instance.setTransform(295.8,262,0.888,0.888,0,0,0,208.1,213.1);
	...
	this.shkala.setTransform(560.1,153.9,1,1,0,0,0,44.1,141.3);
	...
	this.bg.parent = this;
	this.bg.setTransform(299.3,131.7,1,1,0,0,0,326.7,186.7);

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(266.8,38.8,1089,489.2);
