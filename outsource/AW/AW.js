...
(lib.Символ4 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:87.5},12,cjs.Ease.get(1)).to({x:126.5},86).to({x:416.5},10,cjs.Ease.get(-1)).wait(106).to({x:-192.5},0).to({x:87.5},12,cjs.Ease.get(1)).to({x:126.5},86).to({x:416.5},10,cjs.Ease.get(-1)).wait(97));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:147},12,cjs.Ease.get(1)).to({x:127},86).to({x:-183},10,cjs.Ease.get(-1)).wait(106).to({x:467},0).to({x:147},12,cjs.Ease.get(1)).to({x:127},86).to({x:-183},10,cjs.Ease.get(-1)).wait(97));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(319).to({x:118},20,cjs.Ease.get(1)).wait(64).to({x:122.6},0).to({scaleX:1.34,scaleY:1.34,x:-312.4,y:22.5},15,cjs.Ease.get(-1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(108).to({x:126.4},21,cjs.Ease.get(1)).wait(71).to({x:123.3},0).to({regX:132.2,regY:71.5,scaleX:1.63,scaleY:1.63,x:-286.8,y:13.7},14,cjs.Ease.get(-1)).to({_off:true},151).wait(54));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(319).to({y:-25.8,alpha:0},0).to({alpha:1},15).wait(69).to({alpha:0.461},8,cjs.Ease.get(-1)).to({alpha:0},7,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(108).to({y:11.8,alpha:0},0).to({alpha:1},16).wait(76).to({alpha:0.5},7,cjs.Ease.get(-1)).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(204));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/america.jpg?1516973364314", id:"america"},
		{src:"images/AWlogo.png?1516973364314", id:"AWlogo"},
		{src:"images/btn1.png?1516973364314", id:"btn1"},
		{src:"images/btn2.png?1516973364314", id:"btn2"},
		{src:"images/checkboxleo1.png?1516973364314", id:"checkboxleo1"},
		{src:"images/checkboxM60A3Snow1.png?1516973364314", id:"checkboxM60A3Snow1"},
		{src:"images/germany.jpg?1516973364314", id:"germany"},
		{src:"images/Layer610.png?1516973364314", id:"Layer610"},
		{src:"images/leo.png?1516973364314", id:"leo"},
		{src:"images/m60ice.png?1516973364314", id:"m60ice"},
		{src:"images/text1.png?1516973364314", id:"text1"},
		{src:"images/text2.png?1516973364314", id:"text2"},
		{src:"images/Растровоеизображение1.png?1516973364314", id:"Растровоеизображение1"}
	],
	preloads: []
};
