...
(lib.Символ22 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.lf(["#FFFF99","#FFCC00","#FFFF99"],[0,0.498,1],-20,-5.4,20.1,5.4).s().p("AAnITIlRhaQgggJAIgfID0uMQAJggAgAIIFRBbQAgAIgJAgIj0OMQgGAZgVAAQgGAAgHgCg");
	this.shape.setTransform(32.4,53.4);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ22, new cjs.Rectangle(0,0,64.9,106.7), null);
...
(lib.Символ21 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(32.5,53.4,1,1,0,0,0,32.5,53.4);
	this.instance.alpha = 0.25;
	this.instance.compositeOperation = "lighter";
	this.instance.filters = [new cjs.BlurFilter(13, 13, 3)];
	this.instance.cache(-2,-2,69,111);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ21, new cjs.Rectangle(-18,-18,104,146), null);
...
(lib.Символ1 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("AuAD3QggAAAAghIAAmsQAAggAgAAIcBAAQAgAAAAAgIAAGsQAAAhggAAg");
	var mask_graphics_39 = new cjs.Graphics().p("AuAD3QggAAAAghIAAmsQAAggAgAAIcBAAQAgAAAAAgIAAGsQAAAhggAAg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-22,y:48.8}).wait(39).to({graphics:mask_graphics_39,x:-22,y:48.8}).wait(51));

	// Слой 3
	this.instance = new lib.Символ21();
	this.instance.parent = this;
	this.instance.setTransform(-164.9,47.9,1,1,0,0,0,32.5,53.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-24.4},19,cjs.Ease.get(-1)).to({x:123.4},20,cjs.Ease.get(1)).wait(51));

	// Слой 1
	this.instance_1 = new lib.Символ2();
	this.instance_1.parent = this;
	this.instance_1.setTransform(94.5,26,1,1,0,0,0,94.5,26);
...
p.nominalBounds = new cjs.Rectangle(-114.9,24.1,185.8,49.4);
...
(lib.Символ4 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:87.5},12,cjs.Ease.get(1)).to({x:126.5},42).to({x:416.5},10,cjs.Ease.get(-1)).wait(106).to({x:-192.5},0).to({x:87.5},12,cjs.Ease.get(1)).to({x:126.5},43).to({x:416.5},10,cjs.Ease.get(-1)).wait(97));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:147},12,cjs.Ease.get(1)).to({x:127},42).to({x:-183},10,cjs.Ease.get(-1)).wait(106).to({x:467},0).to({x:147},12,cjs.Ease.get(1)).to({x:127},43).to({x:-183},10,cjs.Ease.get(-1)).wait(97));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(252).to({regX:15,regY:10.3,scaleX:0.15,scaleY:0.15,x:3.6,y:60},0).to({regX:14.9,regY:10.7,scaleX:0.79,scaleY:0.79,y:60.2,alpha:1},10).to({regX:14.8,regY:10.8,scaleX:0.61,scaleY:0.61,x:3.5,y:60.3},5).wait(49).to({y:323.8},10).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(235).to({x:49.7},13,cjs.Ease.get(0.5)).wait(68).to({y:323.5},15).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(235).to({x:118},20,cjs.Ease.get(1)).wait(61).to({x:122.6},0).to({scaleX:1.34,scaleY:1.34,x:-312.4,y:22.5},15,cjs.Ease.get(-1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(84).to({regX:15,regY:10.3,scaleX:0.15,scaleY:0.15,x:3.6,y:60},0).to({regX:14.9,regY:10.7,scaleX:0.79,scaleY:0.79,y:60.2,alpha:1},10).to({regX:14.8,regY:10.8,scaleX:0.61,scaleY:0.61,x:3.5,y:60.3},5).to({_off:true},179).wait(54));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(64).to({x:33},15,cjs.Ease.get(0.5)).wait(77).to({y:229.7},14).to({_off:true},108).wait(54));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(64).to({x:126.4},21,cjs.Ease.get(1)).wait(71).to({x:123.3},0).to({regX:132.2,regY:71.5,scaleX:1.63,scaleY:1.63,x:-286.8,y:13.7},14,cjs.Ease.get(-1)).to({_off:true},108).wait(54));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(332));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(232).to({y:-25.8,alpha:0},0).to({alpha:1},15).wait(69).to({alpha:0.461},8,cjs.Ease.get(-1)).to({alpha:0},7,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(64).to({y:11.8,alpha:0},0).to({alpha:1},16).wait(76).to({alpha:0.5},7,cjs.Ease.get(-1)).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(161));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/america.jpg?1517227854714", id:"america"},
		{src:"images/AWlogo.png?1517227854714", id:"AWlogo"},
		{src:"images/btn1.png?1517227854714", id:"btn1"},
		{src:"images/btn2.png?1517227854714", id:"btn2"},
		{src:"images/checkboxleo1.png?1517227854714", id:"checkboxleo1"},
		{src:"images/checkboxM60A3Snow1.png?1517227854714", id:"checkboxM60A3Snow1"},
		{src:"images/germany.jpg?1517227854714", id:"germany"},
		{src:"images/Layer610.png?1517227854714", id:"Layer610"},
		{src:"images/leo.png?1517227854714", id:"leo"},
		{src:"images/m60ice.png?1517227854714", id:"m60ice"},
		{src:"images/text1.png?1517227854714", id:"text1"},
		{src:"images/text2.png?1517227854714", id:"text2"},
		{src:"images/Растровоеизображение1.png?1517227854714", id:"Растровоеизображение1"}
	],
	preloads: []
};
