...
(lib.Символ1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:166.3,alpha:0.688},19,cjs.Ease.get(-1)).to({regX:166.4,alpha:0.898},20,cjs.Ease.get(1)).to({regX:166.3,alpha:0.699},20,cjs.Ease.get(-1)).to({regX:166.4,alpha:0.398},20,cjs.Ease.get(1)).wait(1));

	// Слой 1
	this.instance_2 = new lib._case();
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/_case.png?1505317941040", id:"_case"},
		{src:"images/flash2.png?1505317941040", id:"flash2"},
		{src:"images/FlipKnifeΙDoppler.png?1505317941040", id:"FlipKnifeΙDoppler"},
		{src:"images/Glow7.png?1505317941040", id:"Glow7"},
		{src:"images/GutKnifeΙFade.png?1505317941040", id:"GutKnifeΙFade"},
		{src:"images/OPEN.png?1505317941040", id:"OPEN"},
		{src:"images/OPEN2.png?1505317941040", id:"OPEN2"}
	],
	preloads: []
};
