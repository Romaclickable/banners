...
p.nominalBounds = new cjs.Rectangle(0,0,133,43);
...
(lib.Символ15 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#3300CC","#3366FF"],[0,1],-48.2,51.1,34.6,-62.3).s().p("AsDFAIAArvIV/AAICINfg");
...
(lib.Символ22 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(71,11,1,1,0,0,0,73,16);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.06,scaleY:1.06,x:71.1,y:8.1},11,cjs.Ease.get(-1)).to({scaleX:1.14,scaleY:1.14,x:71,y:4.6},13,cjs.Ease.get(1)).to({scaleX:1.07,scaleY:1.07,x:71.1,y:7.7},12,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,x:71,y:11},13,cjs.Ease.get(1)).wait(1));

	// CS_GO Skins.png
	this.instance_1 = new lib.Символ24();
	this.instance_1.parent = this;
	this.instance_1.setTransform(71,46.5,1,1,0,0,0,73,18.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regY:18.6,scaleX:0.94,scaleY:0.94,y:46.7},11,cjs.Ease.get(-1)).to({scaleX:0.88,scaleY:0.88,x:71.1,y:46.6},13,cjs.Ease.get(1)).to({regY:18.7,scaleX:0.94,scaleY:0.94,y:46.7},12,cjs.Ease.get(-1)).to({regY:18.5,scaleX:1,scaleY:1,x:71,y:46.5},13,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2,-5,146,70);
...
p.nominalBounds = new cjs.Rectangle(0,0,133,44);
...
(lib.Символ16 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:20.3},14,cjs.Ease.get(-1)).to({y:19},15,cjs.Ease.get(1)).to({y:20.3},15,cjs.Ease.get(-1)).to({y:21.5},15,cjs.Ease.get(1)).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/ak.png?1504692019576", id:"ak"},
		{src:"images/atfingertips.png?1504692019576", id:"atfingertips"},
		{src:"images/bg.jpg?1504692019576", id:"bg"},
		{src:"images/btn1.jpg?1504692019576", id:"btn1"},
		{src:"images/btn2.jpg?1504692019576", id:"btn2"},
		{src:"images/CS_GOSkins.png?1504692019576", id:"CS_GOSkins"},
		{src:"images/Fog.png?1504692019576", id:"Fog"},
		{src:"images/golova.png?1504692019576", id:"golova"},
		{src:"images/Group.png?1504692019576", id:"Group"},
		{src:"images/kamni.png?1504692019576", id:"kamni"},
		{src:"images/logo_big.png?1504692019576", id:"logo_big"},
		{src:"images/plecho.png?1504692019576", id:"plecho"},
		{src:"images/ruka.png?1504692019576", id:"ruka"},
		{src:"images/telo.png?1504692019576", id:"telo"}
	],
	preloads: []
};
