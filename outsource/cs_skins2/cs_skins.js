...
p.nominalBounds = new cjs.Rectangle(0,0,234,76);
...
(lib.Символ18 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,0,0.568,0.568);

	this.instance_1 = new lib.btn2();
	this.instance_1.parent = this;
	this.instance_1.setTransform(0,1,0.568,0.568);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,132.8,43.2);
...
p.nominalBounds = new cjs.Rectangle(0,0,132.8,44.2);
