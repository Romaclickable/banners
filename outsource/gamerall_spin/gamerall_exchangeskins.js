...
p.nominalBounds = new cjs.Rectangle(0,0,171,25);// helper functions:
...
(lib.Символ13 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FF0000").s().p("ApsETIAAolIRsAAIBtIlg");
...
(lib.Символ8 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(105,6);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(1,-6,1.17,1.17);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(42.1,9.2,1,1,0,0,0,56.6,27.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ8, new cjs.Rectangle(-19,-18.5,312,55.2), null);
...
p.nominalBounds = new cjs.Rectangle(143,116.5,312,259.7);
// library properties:
lib.properties = {
	width: 300,
	height: 250,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/arow.png?1502895774083", id:"arow"},
		{src:"images/asimov.png?1502895774083", id:"asimov"},
		{src:"images/bg.jpg?1502895774083", id:"bg"},
		{src:"images/btn.png?1502895774083", id:"btn"},
		{src:"images/btn2.png?1502895774083", id:"btn2"},
		{src:"images/flash_asimov.png?1502895774083", id:"flash_asimov"},
		{src:"images/flash_knife.png?1502895774083", id:"flash_knife"},
		{src:"images/Flash_money.png?1502895774083", id:"Flash_money"},
		{src:"images/knife.png?1502895774083", id:"knife"},
		{src:"images/logo.png?1502895774083", id:"logo"},
		{src:"images/money.png?1502895774083", id:"money"},
		{src:"images/platezhki.png?1502895774083", id:"platezhki"},
		{src:"images/sell.png?1502895774083", id:"sell"}
	],
	preloads: []
};
