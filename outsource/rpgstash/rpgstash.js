...
}).prototype = getMCSymbolPrototype(lib.Символ15, new cjs.Rectangle(0,0,130,118), null);
...
(lib.Символ17 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:84.1,regY:7.9,x:395.1,y:-113.7},9,cjs.Ease.get(-1)).to({regX:84,regY:8,x:395,y:-114.7},10,cjs.Ease.get(1)).to({regX:84.1,regY:7.9,x:395.1,y:-113.8},10,cjs.Ease.get(-1)).to({regX:84,regY:8,x:395,y:-112.7},10,cjs.Ease.get(1)).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(5).to({regX:84.1,x:395.1,y:-94.5},9,cjs.Ease.get(-1)).to({regX:84,x:395,y:-95.6},10,cjs.Ease.get(1)).to({regX:84.1,x:395.1,y:-94.6},10,cjs.Ease.get(-1)).to({regX:84,x:395,y:-93.6},10,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(320,-119.9,150,34);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bashka.png?1504874861741", id:"bashka"},
		{src:"images/bg.jpg?1504874861741", id:"bg"},
		{src:"images/btn1.png?1504874861741", id:"btn1"},
		{src:"images/btn2.png?1504874861741", id:"btn2"},
		{src:"images/CompleteRotMGShop.png?1504874861741", id:"CompleteRotMGShop"},
		{src:"images/flash.png?1504874861741", id:"flash"},
		{src:"images/madgod_logo.png?1504874861741", id:"madgod_logo"},
		{src:"images/Potions.png?1504874861741", id:"Potions"},
		{src:"images/rpgstash_1.png?1504874861741", id:"rpgstash_1"}
	],
	preloads: []
};
